...
#define DEV_NAME  L"\\Device\\firstTimer-DPC"
#define SYM_NAME  L"\\DosDevices\\firstTimer-DPC"
#define MSG       "WDM driver tutorial for Timer-DPC"
...
//*** timer routine
VOID DpcTimer(struct _KDPC *Dpc, PVOID DeferredContext, PVOID SystemArgument1, PVOID SystemArgument2)
{
  dwTimerCnt+= 1;
  DbgPrint("DpcTimer: %d\n", dwTimerCnt);
}
...
NTSTATUS AddDevice(PDRIVER_OBJECT pOurDriver, PDEVICE_OBJECT pPhyDevice)
{
  ...
  KeInitializeDpc(&stTimerDPC, DpcTimer, pOurDevice);
